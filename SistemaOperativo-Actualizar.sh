...
# ----------
#  Script de NiPeGun para actualizar Kali
#
#  Ejecución remota:
#  curl -s https://raw.githubusercontent.com/nipegun/k-scripts/main/SistemaOperativo-Actualizar.sh | bash
# ----------
...
echo ""
echo -e "${ColorVerde}  Iniciando el script de actualización de Kali...${FinColor}"
echo ""
